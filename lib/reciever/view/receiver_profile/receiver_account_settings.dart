...
class ReceiverAccountSettings extends StatefulWidget {
  const ReceiverAccountSettings({Key? key}) : super(key: key);

  @override
  State<ReceiverAccountSettings> createState() =>
      _ReceiverAccountSettingsState();
}

class _ReceiverAccountSettingsState extends State<ReceiverAccountSettings> {
